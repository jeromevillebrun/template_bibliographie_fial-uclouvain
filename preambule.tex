...
\usepackage[style=verbose-trad3,sortlocale=auto,sortcase=false,maxnames=3,minnames=1,backref=false,backrefstyle=three,isbn=false,url=false,doi=false,eprint=false,citepages=omit,nosortothers=true,strict=false,abbreviate=false]{biblatex}
...
%- abbreviate (=true par défaut) mettre sur false pour qu'il n'utilise pas de chaines de langues abrégées.
...
%Il faut essayer de remplacer les deux points entre lieu et maison d'édition par une virgule.

% Formatage des noms > on branche tout sur family-given
