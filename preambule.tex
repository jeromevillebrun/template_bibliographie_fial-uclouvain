...
\usepackage[
	style=authortitle-ibid,%style (=numeric par défaut). Mettre sur un style verbose-trad2 ou 3, c'est le style qui ressemble le plus à celui de la FIAL. Il faut mieux mettre verbose-trad3 que verbose-trad2 parce que verbose-trad2 indique pp. X-Y quand il y a plusieurs pages, tandis que trad3 indique p. X-Y.
