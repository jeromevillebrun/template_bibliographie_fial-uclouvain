...
\DeclareFieldFormat{volumes}{\ifnumerals{volume}{#1~\bibstring{volumes}}{#1~vol\adddot}}%Même concept que le précédent
...
\newbibmacro*{date}{\iffieldundef{date}{\printtext{s\adddot d\adddot}}{\printdate}}
